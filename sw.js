const CACHE="lerninsel-v8.2-20260916";
const ASSETS=["./","./index.html","./config.js","./app.js","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png"];
